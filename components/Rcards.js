    ...
    <div className="bg-white p-6 mx-4 my-10 rounded-lg shadow-lg">
      ...
      <div className="bg-gradient-to-br from-black via-gray-900 to-black p-8 rounded-lg">
        ...
        <div className="container mx-auto px-6 lg:px-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-navy-800 via-black to-navy-900 text-white rounded-lg shadow-lg p-6 hover:scale-105 transition-transform duration-500 h-full flex flex-col">
